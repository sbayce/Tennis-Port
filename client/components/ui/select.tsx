...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      `relative flex w-full after:content-[''] after:absolute after:left-1/2 after:bottom-0 after:h-[1px] after:w-0 after:bg-[#202223] after:transition-all after:duration-300 hover:after:w-3/4 hover:after:left-4 cursor-pointer select-none items-center rounded-sm hover:opacity-100 
