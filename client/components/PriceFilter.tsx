...
const PriceFilter = () => {
  ...
  function handleChange(e: React.ChangeEvent<HTMLInputElement>, type: 'min' | 'max') {
      ...
      <div className='flex flex-col gap-4 items-center mt-4'>
          ...
          <div className="flex gap-2">
              ...
              <input ref={minInputRef} value={priceRange[0] !== MIN_PRICE ? priceRange[0] : ""} 
                ...
                min={MIN_PRICE} max={MAX_PRICE} className="border rounded-xl py-3 px-2 w-24 text-sm text-center" 
